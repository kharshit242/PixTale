...
# Import our nvidia langchain services
from utils.nvidia_langchain_services import generate_story_from_image
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("Usage: python test_nvidia_story.py <path_to_image>")
